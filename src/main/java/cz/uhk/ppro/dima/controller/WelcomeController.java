...
public class WelcomeController {
    ...
    @Autowired
    public WelcomeController(UserService userService, ArticleService articleService) {
        this.userService = userService;
        this.articleService = articleService;
    }

    @RequestMapping(value ="/", method = RequestMethod.GET)
    public ModelAndView welcome(@ModelAttribute("article") Article article, ModelMap modelMap) {
